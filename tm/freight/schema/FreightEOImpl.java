...
// ---------------------------------------------------------------------
public class FreightEOImpl extends OAEntityImpl
{
  ...
  public static final int PRIORITYCODE = 59;
  ...
  public static synchronized EntityDefImpl getDefinitionObject()
  {
    ...
    {
      mDefinitionObject = 
          (OAEntityDefImpl)EntityDefImpl.findDefObject("xxgam.oracle.apps.xbol.tm.freight.schema.FreightEO");
    }
  ...
  /**Gets the attribute value for IdFolio, using the alias name IdFolio
   */
  ...
  /**Sets <code>value</code> as the attribute value for IdFolio
   */
  ...
  /**Gets the attribute value for IdStretch, using the alias name IdStretch
   */
  ...
  /**Sets <code>value</code> as the attribute value for IdStretch
   */
  ...
  /**Gets the attribute value for UseRate, using the alias name UseRate
   */
  ...
  /**Sets <code>value</code> as the attribute value for UseRate
   */
  ...
  /**Gets the attribute value for IdClassification, using the alias name IdClassification
   */
  ...
  /**Sets <code>value</code> as the attribute value for IdClassification
   */
  ...
  /**Gets the attribute value for IdDistribution, using the alias name IdDistribution
   */
  ...
  /**Sets <code>value</code> as the attribute value for IdDistribution
   */
  ...
  /**Gets the attribute value for IdMedia, using the alias name IdMedia
   */
  ...
  /**Sets <code>value</code> as the attribute value for IdMedia
   */
  ...
  /**Gets the attribute value for IdMode, using the alias name IdMode
   */
  ...
  /**Sets <code>value</code> as the attribute value for IdMode
   */
  ...
  /**Gets the attribute value for ModeCode, using the alias name ModeCode
   */
  ...
  /**Sets <code>value</code> as the attribute value for ModeCode
   */
  ...
  /**Gets the attribute value for ModeDesc, using the alias name ModeDesc
   */
  ...
  /**Sets <code>value</code> as the attribute value for ModeDesc
   */
  ...
  /**Gets the attribute value for IdProvider, using the alias name IdProvider
   */
  ...
  /**Sets <code>value</code> as the attribute value for IdProvider
   */
  ...
  /**Gets the attribute value for EtdHour, using the alias name EtdHour
   */
  ...
  /**Sets <code>value</code> as the attribute value for EtdHour
   */
  ...
  /**Gets the attribute value for EtaHour, using the alias name EtaHour
   */
  ...
  /**Sets <code>value</code> as the attribute value for EtaHour
   */
  ...
  /**Gets the attribute value for FreightJob, using the alias name FreightJob
   */
  ...
  /**Sets <code>value</code> as the attribute value for FreightJob
   */
  ...
  /**Gets the attribute value for AwbBol, using the alias name AwbBol
   */
  ...
  /**Sets <code>value</code> as the attribute value for AwbBol
   */
  ...
  /**Sets <code>value</code> as the attribute value for Flight
   */
  ...
  /**Sets <code>value</code> as the attribute value for Pediment
   */
  ...
  /**Gets the attribute value for MultipleDeliveriesFlag, using the alias name MultipleDeliveriesFlag
   */
  ...
  /**Sets <code>value</code> as the attribute value for MultipleDeliveriesFlag
   */
  ...
  /**Gets the attribute value for NumDeliveries, using the alias name NumDeliveries
   */
  ...
  /**Sets <code>value</code> as the attribute value for NumDeliveries
   */
  ...
  /**Sets <code>value</code> as the attribute value for Document4
   */
   ...
   */
  public static Key createPrimaryKey(Number idFreight)
  {
    return new Key(new Object[]{idFreight});
  }
}
